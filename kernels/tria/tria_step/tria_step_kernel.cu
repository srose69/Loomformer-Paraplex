// kernels/tria/tria_step/tria_step_kernel.cu -- standalone compilable TU
...
//   nvcc -arch=sm_61 --ptx tria_step_kernel.cu -o tria_step_kernel.ptx
...
// torch-free).
template __global__ void tria_step_forward_kernel<float>(const float* __restrict__ r, const float* __restrict__ i_, const float* __restrict__ o,
    const float* __restrict__ carry_prev,   
    float* __restrict__ carry_new,          
    float* __restrict__ scale_out,          
    float alpha, int axis, int64_t n);
template __global__ void tria_step_backward_kernel<float>(const float* __restrict__ grad_carry_new,
