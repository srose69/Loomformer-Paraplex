// kernels/tria/tria_init_gate/tria_init_gate_kernel.cu -- standalone compilable TU
...
//   nvcc -arch=sm_61 --ptx tria_init_gate_kernel.cu -o tria_init_gate_kernel.ptx
...
// torch-free).
template __global__ void tria_init_gate_forward_kernel<float>(const float* __restrict__ r, const float* __restrict__ i_, const float* __restrict__ o,
    const float* __restrict__ w,
    float* __restrict__ carry_1,
    float* __restrict__ p_out,
    float* __restrict__ scale_out,
    float alpha, int axis, int64_t n);
template __global__ void tria_init_gate_backward_kernel<float>(const float* __restrict__ grad_carry_1,
